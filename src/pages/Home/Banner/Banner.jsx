  ...
  return (
    <div className="carousel w-full  md:h-[700px]">
      <div id="slide1" className="carousel-item relative w-full">
        ...
        {/* banner writting section... */}
        <div className="absolute h-full flex items-center left-0 top-0  rounded-xl bg-gradient-to-r from-[#181717] to-[rgba(21,21,21,0)]">
          <div className="text-white md:space-y-7 pl-12 w-1/2">
        ...
        <div className="absolute flex justify-end transform -translate-y-1/2 left-5 right-5 bottom-0 ">
          <a
            href="#slide4"
            className="btn btn-circle btn-outline btn-error mr-4"
          >
            <FaArrowLeft />
          </a>
      ...
      <div id="slide5" className="carousel-item relative w-full">
        ...
        <div className="absolute flex justify-end transform -translate-y-1/2 left-5 right-5 bottom-0">
          ...
          <a href="#slide6" className="btn btn-circle btn-outline btn-error">
            <FaArrowRight />
          </a>
        </div>
      </div>
